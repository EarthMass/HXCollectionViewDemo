...
#import "HXHorCardVC.h"
#import "HXHorCardFlowout.h"

@interface HXHorCardVC ()<UICollectionViewDelegate,UICollectionViewDataSource>

@property (nonatomic, strong) NSMutableArray * dataArr;
@property (nonatomic, strong) UICollectionView * collectioView;
@property (nonatomic, strong) HXHorCardFlowout * flowLayout;

@end

@implementation HXHorCardVC
...
- (HXHorCardFlowout *)flowLayout {
    if (!_flowLayout) {
        _flowLayout = [[HXHorCardFlowout alloc] init];
