...
#import "HXCardCollectionVC.h"
#import "HXCardLayout.h"

@interface HXCardCollectionVC ()<UICollectionViewDelegate,UICollectionViewDataSource>

@property (nonatomic, strong) NSMutableArray * dataArr;
@property (nonatomic, strong) UICollectionView * collectioView;
@property (nonatomic, strong) HXCardLayout * flowLayout;

@end

@implementation HXCardCollectionVC
...
- (HXCardLayout *)flowLayout {
    if (!_flowLayout) {
        _flowLayout = [[HXCardLayout alloc] init];
